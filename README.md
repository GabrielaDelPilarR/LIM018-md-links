...
[MD-LINKS] Es una libreria de NodeJS que permite analizar los archivos de tipo Markdown, ya sea desde un archivo o directorio, que pueden estar alojados dentro de carpetas .
...
### Casos
Si el usuario no ingresa ningun archivo se mostrará el mensaje indicando que debe hacerlo.
![SinRuta](./md-links.JPG)
...
Si se ingresa una ruta con la opcion --validate le saldra el status de los links      
 haciendo consultas HTTP con axios. Si el link resulta en una redirección a una URL que responde ok, entonces consideraremos el link como ok.
